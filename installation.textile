...
# (Recommended for most people) Download the "zipped package":http://github.com/bsag/tracks/zipball/v2.0RC, and unzip in your preferred location (e.g. @~/Sites@ for Mac OS X users).
...
# Tracks itself
# Rails 2.3.5 (installed in the @/vendor/rails@ directory, so you do not need to install Rails yourself)
...
This description is intended for people installing Tracks from scratch. If you would like to upgrade an existing installation, please see Upgrading to Tracks 2.0RC.

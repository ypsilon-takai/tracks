...
# (Recommended for most people) Download the "zipped package":https://github.com/bsag/tracks/zipball/v2.0 for the latest stable release (2.0) and unzip in your preferred location (e.g. @~/Sites@ for Mac OS X users).
